...
class ScrapITApplication : Application() {
    ...
    companion object {
        ...
        fun setCurrentFolderId(context: Context, id: Int) {
            ...
            pref.edit().putInt("currentFolderId", id).apply()
        }
    ...
    override fun onCreate() {
        ...
        val rootFolderId = -1
        rootFolder = realm.where(Folder::class.java).equalTo("folderId", rootFolderId).findFirst()
            ?: Folder()
    ...
    private fun testStackFragment() {
        ...
        val folder5 = Folder()
        folder5.folderId = 5
        folder5.nickname = "폴더 55"
        folder5.description = "폴더 5의 설명"
        folder5.color = "#C1A5FF"
        folder5.isFavorites = false
        ...
        folder4.childFolderList.add(folder5)
        ...
        realm.executeTransaction {
            ...
            it.copyToRealmOrUpdate(folder5)
        }
